					...
					<div class="sign__content">
                        ...
                        @csrf
							...
							<div class="sign__group">
								<input  class="sign__input" placeholder="Email" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" >
							...
							<div class="sign__group">
								<input  class="sign__input" placeholder="Password" type="password" name="password" required autocomplete="current-password">
