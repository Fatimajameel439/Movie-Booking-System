        ...
        <div class="row">
            <div class="col-md-4">
                <div class="sign__group">
                    ...
                    <input class="sign__input" name="name" required="" pattern="[a-zA-Z]" type="text" placeholder="Enter your Name">
            ...
            <div class="col-md-4">
                ...
                <div class="sign__group">
                    ...
                    <select class="me-sm-2 default-select sign__input wide" name="movie" id="movieSelect">
                        ...
                        <option value="{{$movie->name}}">{{ $movie->name }}
                        </option>
                        @endforeach
                    </select>
                </div>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="">Name</label>
                                                    <input class="sign__input" name="name" required pattern="[a-zA-Z]+( [a-zA-Z]+)*" type="text" placeholder="Enter your Name">
                                                    <div id="nameError" style="color: red;"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="">Contact No</label>
                                                    <input class="sign__input" required="" type="number" required name="contact" placeholder="Enter your contact No">
                                                </div>
                                                <div class="form-group">
                                                    <label for="theaterSelect">Theater</label>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="quantity">No of ticket (1 to 20):</label>
                                                    <input type="number" class="sign__input" id="quantity" name="quantity" min="1" max="20" value="1" required>
                                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const nameInput = document.querySelector('.sign__input[name="name"]');
        const nameError = document.getElementById('nameError');

        nameInput.addEventListener('keyup', function() {
            const inputValue = nameInput.value.trim();
            if (inputValue === '') {
            nameError.textContent = 'Space character not allowed';
        } else if (!/^[a-zA-Z]+( [a-zA-Z]+)*$/.test(inputValue)) {
            nameError.textContent = 'Only alphabetic characters allowed.';
        } else {
