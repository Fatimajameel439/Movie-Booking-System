...
<div class="home home--static">
    <div class="home__carousel owl-carousel" id="flixtv-hero">
        ...
        <div class="home__card">
            <a href="{{url('/show-movie', $movie->id)}}">       
            ...
            <div class="col-12">
                ...
                <div class="row row--grid">
                    ...
                    <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                        <div class="card">
                            <a href="{{url('show2-movie', $movie->id)}}" class="card__cover">
                                <img src="{{asset($movie->image)}}" alt="">
            ...
            <div class="col-12">
                <div class="section__carousel-wrap">
                    <div class="section__carousel owl-carousel" id="subscriptions">
                        @foreach($movies->slice(4,9) as $movie)
                        <div class="card">
                            <a href="{{url('/show-movie', $movie->id)}}" class="card__cover">
                                <img src="{{asset($movie->image)}}" alt="">
                            ...
                            <h3 class="card__title card__title--subs"><a href="details.html">{{$movie->name}}</a></h3>
...
<section class="section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="section__title"><b>Flix</b>Originals Theaters</h2>
                <p class="section__text">Comfort,Reliability,Ambience,Entertainment,Acoustics, Visuals,Hospitality,Technology,Convenience,Luxury</p>
            </div>
            ...
            <div class="col-12">
                <div class="section__carousel-wrap">
                    <div class="section__interview owl-carousel" id="flixtv">
                        ...
                        <div class="interview">
                            <a href="#" class="interview__cover">
                                <img src="{{asset($theater->image)}}" alt="">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="img-fluid">
                                        <circle cx="50" cy="50" r="40" stroke="black" stroke-width="3" fill="#FFD700" />
                                        <rect x="25" y="35" width="50" height="10" fill="#333" />
                                        <rect x="25" y="55" width="50" height="10" fill="#333" />
                                        <text x="50%" y="90%" text-anchor="middle" fill="#333" font-size="10" font-family="Arial" dy=".3em">Theater</text>
                                    </svg><h3 class="interview__title">{{$theater->name}}</h3>
                                </span>
                            </a>
                            <h3 class="interview__title"><a href="interview.html">{{$theater->address}}</a></h3>
                            <h4 lass="interview__title">{{$theater->status}}</h4>
                        </div>
                        @endforeach
                    </div>
