...
<!-- Mirrored from flixtv.volkovdesign.com/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 05:50:05 GMT -->
<head>
	<meta charset="utf-8">
	...
	<link rel="stylesheet" href="{{asset('assets/main/css/slider-radio.css')}}">
	...
	<!-- Favicons -->
	<link rel="icon" type="image/png" href="{{asset('assets/main/img/favicon-32x32.png')}}" sizes="32x32">
	<link rel="apple-touch-icon" href="{{asset('assets/main/icon/favicon-32x32.png')}}">

	<meta name="description" content="">
	<meta name="keywords" content="">
	<meta name="author" content="Dmitry Volkov">
	<title> – Movies & TV Shows, Online cinema </title>
	<style>
		.ticket {
    border: 2px solid #007bff; /* Replace with your theme color */
    border-radius: 8px;
    padding: 20px;
...
<body>
				...
				<div class="col-12">
					<div class="header__content">
						...
						<a href="{{url('/')}}" class="header__logo">
							<img src="{{asset('assets/main/img/logo.svg')}}" alt="Movies & TV Shows, Online cinema HTML Template">
						</a>
						...
						<ul class="header__nav">
							...
							<li class="header__nav-item">
								<a class="header__nav-link" href="{{asset('assets/main/about.html')}}">About Us</a>
							</li>
							<li class="header__nav-item">
								<a class="header__nav-link" href="{{url('allmovie')}}">Movie List</a>
							</li>
							<li class="header__nav-item">
								<a class="header__nav-link" href="{{url('booking')}}">Booking</a>
							</li>
							
							<li class="header__nav-item">
								<a class="header__nav-link" href="{{url('contact-page')}}">Contact</a>
							</li>
							<li class="header__nav-item">
								...
								<ul class="dropdown-menu header__nav-menu header__nav-menu--scroll" aria-labelledby="dropdownMenu3">
									<li><a href="{{asset('assets/main/interview.html')}}">Interview</a></li>
									<li><a href="{{asset('assets/main/privacy.html')}}">Privacy policy</a></li>
									<li><a href="{{asset('assets/main/signin.html')}}">Sign in</a></li>
									<li><a href="{{asset('assets/main/signup.html')}}">Sign up</a></li>
								</ul>
							</li>
						</ul>
			...
			<div class="row">
				<div class="col-12">
					<div class="footer__content">
						...
						<small class="footer__copyright">© FlixTV, 2024. Created by S.Noman Ali & fatima Jameel</small>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="{{asset('assets/main/js/slider-radio.js')}}"></script>
...
<!-- Mirrored from flixtv.volkovdesign.com/main/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jul 2024 05:50:39 GMT -->
</html>