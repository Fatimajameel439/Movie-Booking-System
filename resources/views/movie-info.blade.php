...
<section class="section section--head section--head-fixed section--gradient section--details-bg">
    <div class="section__bg" data-bg="{{asset($movies->image
    )}}"></div>
    <div class="container">
        <!-- article -->
        <div class="article">
            <div class="row">
                <div class="col-12 col-xl-8">
                    <!-- trailer -->
                    <a href="{{url('book-info', $movies->id)}}" class="btn btn-danger" style="padding: 10px 20px; margin-top:20px;">Get Ticket</a>
                    <!-- end trailer -->
                    ...
                    <div class="article__content">
                        ...
                        <ul class="list">
                            ...
                            <li>{{ $movies->desc }}</li>
                            <li>{{ $movies_datetime->show_date }}</li>
                            <li>{{ $movies_datetime->show_time }}</li>
                ...
                <!-- video player -->
                <div class="col-12 col-xl-8">
                    <video controls crossorigin playsinline poster="{{asset($movies->image)}}" id="player">
                        <!-- Video files -->
                        <source src="{{ asset($movies->trailer) }}" type="video/mp4" size="576">
                ...
                <div class="col-12">
                    <div class="series-wrap">
                        <h3 class="series-wrap__title"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            </svg> Rlated Movies</h3>
                        <div class="section__carousel-wrap">
                            <div class="section__series owl-carousel" id="series">
                                @foreach($allmovies->slice(4) as $movies)
                                <div class="series">
                                    <a href="{{url('/show-movie', $movies->id)}}" class="series__cover">
                                        <img src="{{asset($movies->image)}}" alt="">
                                        <span>
                                    ...
                                    <h3 class="series__title"><a href="details.html.html">{{$movies->name}}</a></h3>
                                </div>
                                @endforeach
                                ...
                                <div class="comments">
                                    ...
                                    <form id="comment-form" class="comments__form">
                                        ...
                                        <div class="form-group">
                                            <textarea id="message" name="comment" class="form-control" placeholder="Add comment"></textarea>
                                        </div>
        ...
        $('#comment-form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#comments-list').append(`
                            <li class="comments__item">
                                <div class="comments__autor">
                                    <img class="comments__avatar" src="{{ asset('assets/img/avatar.svg') }}" alt="">
                                    <span class="comments__name">${response.comment.user.name}</span>
                                    <span class="comments__time">${new Date(response.comment.created_at).toLocaleString()}</span>
                                </div>
                                <p class="comments__text">${response.comment.comment}</p>
                            </li>
                        `);
                ...
                error: function(response) {
                    alert('Error adding comment: ' + response.responseJSON.message);
                }
            });
        });
    });
